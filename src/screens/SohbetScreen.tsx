...
const UPCOMING = [
  { icon: 'chatbubble-ellipses-outline' as const, title: 'Kişisel Sohbet', desc: 'İstediğin kişiyle birebir yazılı sohbet.' },
  { icon: 'mic-outline' as const, title: '10 Kişilik Sesli Odalar', desc: 'Koltuğa oturarak sesli sohbete katıl, yazarak paralel sohbet et.' },
  { icon: 'people-outline' as const, title: 'Arkadaşlık Sistemi', desc: 'Takip et, arkadaş ekle, istediğinle sohbeti sürdür.' },
];
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroText}>
            Bu bölüm şu anda inşa ediliyor. Hazır olduğunda burada kişisel mesajlaşma ve 10 kişilik sesli/yazılı sohbet
            odaları olacak.
          </Text>
        </View>
