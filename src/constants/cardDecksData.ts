...
export const POPULAR_CARD_DECKS: CardDeckInfo[] = [
  ...
  },
  {
    ...
    figureSource: require('@/assets/cards/lenormand/lenormand_01.png'),
    sectionBg: require('@/assets/backgrounds/decks/lenormand_bg.jpg'),
    cardBackImage: require('@/assets/tarot-backs/premium-back.jpg'),
    tags: ['Net Kehanet', '36 Kart', 'Günlük Hayat', 'Tavsiye'],
    sampleCards: [
      { id: 'suvari', name: '1. Süvari', image: require('@/assets/cards/lenormand/lenormand_01.png'), suitSymbol: '🐎', rankLabel: '01', themeColor: '#06B6D4' },
      { id: 'yonca', name: '2. Yonca', image: require('@/assets/cards/lenormand/lenormand_02.png'), suitSymbol: '🍀', rankLabel: '02', themeColor: '#10B981' },
      { id: 'gemi', name: '3. Gemi', image: require('@/assets/cards/lenormand/lenormand_03.png'), suitSymbol: '⛵', rankLabel: '03', themeColor: '#3B82F6' },
      { id: 'yuzuk', name: '25. Yüzük', image: require('@/assets/cards/lenormand/lenormand_25.png'), suitSymbol: '💍', rankLabel: '25', themeColor: '#F59E0B' },
    ],
  },
  {
    id: 'angel',
