...
export const POPULAR_CARD_DECKS: CardDeckInfo[] = [
  ...
  {
    id: 'rune',
    title: 'Nordik Elder Futhark Rün Kartları',
    shortTitle: 'Rünik Deste',
    tagline: '24 Kutsal Rün · Viking Kadim Savaşçı & Koruma Enerjisi',
    description:
      'Odin’in dokuz diyardan getirdiği 24 kutsal rünik sembol. Güç, direnç, bolluk ve görünmeyen tuzaklara karşı ilahi kalkan.',
    cardCount: 24,
    accent: '#38BDF8',
    ...
    figureSource: require('@/assets/tarot/ermis.jpg'),
    sectionBg: require('@/assets/backgrounds/decks/rune_bg.jpg'),
    cardBackImage: require('@/assets/tarot-backs/premium-back.jpg'),
